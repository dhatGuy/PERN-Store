...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    ...
    link: "bg-transparent border border-transparent hover:bg-gray-100 focus:ring-gray-500",
  };
  ...
  return (
    <button className={cn(buttonClasses, className)} disabled={loading || disabled} {...props}>
      {loading ? (
